...
function EduForm({ initial, onSave, onClose }: { initial?: Education; onSave: (d: Omit<Education,'id'>) => void; onClose: () => void }) {
...
export default function Edu() {
  ...
  return (
    <section id="education" className="py-36 px-8 relative overflow-hidden"
